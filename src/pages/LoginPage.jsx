                ...
                <div className="col-md-7 animated fadeIn col-lg-6 center-screen">
                    <div className="card w-90  p-4">
                        <div className="card-body">
                            ...
                            <input id="email" placeholder="User Email" className="form-control"  name="email" type="email"/>
                            <br/>
                            <input id="password" placeholder="User Password" className="form-control" name ="password" type="password"/>
                            <br/>
